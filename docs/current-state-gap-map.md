...
| ML-DSA-65 | Complete provider foundation | The supported .NET ML-DSA-65 provider is implemented and production fails closed when platform support or the explicit managed-signer readiness contract is unavailable. Audited managed key custody remains production integration work. |
