...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddHipInfrastructure(this IServiceCollection services, IConfiguration configuration, bool isLocalDevelopment = true)
    {
        ...
        services.AddSingleton<IDnsLookupProvider, DnsClientLookupProvider>();
        ...
        services.AddScoped<IDomainCertificateMonitoringRepository>(provider => provider.GetRequiredService<EfDomainCertificateRepository>());
        services.AddScoped<IDomainCertificateMonitoringScheduleRepository>(provider => provider.GetRequiredService<EfDomainCertificateRepository>());
